...
#define S_GOOD   1
#define S_BAD    0
#define S_UGLY   2 /* name selection state, only used for referrence to
                      The Good, The Bad, and The Ugly */

#define N     8192

#define MESSAGE "\nWelcome to our chat server.\n\n"
#define LOGMSG "Please enter a username: "
