...
void gill()
{
  ...
  glBegin(GL_POLYGON);//door
    ...
    glVertex3f( -0.2,  0.25, 0.51);
    glVertex3f(  0.2,  0.25, 0.51);
    glVertex3f(  0.2,  0.0, 0.51);
  glEnd();
//  windo(6, 0.99, 0.01, 0.51);
  windo(4, 0.96, 0.29, 0.51);
  windo(4, 0.96, 0.59, 0.51);
  ...
  glBegin(GL_POLYGON);//door
    ...
    glVertex3f(  0.2,  0.0, -0.51);
  glEnd();
  glBegin(GL_POLYGON);//big window
    glColor3f(1.0,0.5,1.0);
    glVertex3f(  0.6,  0.0, -0.51);
    glVertex3f(  0.6,  1.4, -0.51);
    glVertex3f(  0.22, 1.4, -0.51);
    glVertex3f(  0.22, 0.0, -0.51);
  glEnd();
  windo(4, 1.45, 0.19, -0.51);
  windo(4, 1.45, 0.69, -0.51);
  windo(4, 1.45, 0.99, -0.51);
