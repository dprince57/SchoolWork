...
main(int argc, char *argv[])
{
  ...
  // lab8 - also print whether the file is a palindrome (in terms of the lines,
  //  check if line 1 is the same as the last line, line 2 is the same as the
  //  second last, etc.
  // printf("File is line-palindromic.\n");
  // printf("File is not line-palindromic.\n");
